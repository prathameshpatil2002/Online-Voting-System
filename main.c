...
node *voter_insert(node *start)
{
    ...
    while (temp != NULL)
    {
        if ((strcmp(temp->aadhar, "10001") == 0 && strcmp(temp->name, "Yash Ojha") == 0 && strcmp(temp->birth_date, "04-06-2002") == 0) ||
            (strcmp(temp->aadhar, "10002") == 0 && strcmp(temp->name, "prathamesh Patil") == 0 && strcmp(temp->birth_date, "04-04-2002") == 0) ||
            (strcmp(temp->aadhar, "10003") == 0 && strcmp(temp->name, "Nilay Singh") == 0 && strcmp(temp->birth_date, "12-10-1999") == 0) ||
            (strcmp(temp->aadhar, "10004") == 0 && strcmp(temp->name, "Harsh Tripathi") == 0 && strcmp(temp->birth_date, "08-12-1999") == 0) ||
            (strcmp(temp->aadhar, "10005") == 0 && strcmp(temp->name, "Aniket Giri") == 0 && strcmp(temp->birth_date, "28-08-1999") == 0) ||
            (strcmp(temp->aadhar, "10006") == 0 && strcmp(temp->name, "Harsh Upadhyay") == 0 && strcmp(temp->birth_date, "20-10-2000") == 0) ||
            (strcmp(temp->aadhar, "10007") == 0 && strcmp(temp->name, "Amandeep Singh") == 0 && strcmp(temp->birth_date, "02-03-1999") == 0) ||
            (strcmp(temp->aadhar, "10008") == 0 && strcmp(temp->name, "Niraj Matare") == 0 && strcmp(temp->birth_date, "26-12-1999") == 0))
...
void voting()
{
    ...
    Sleep(300);
    printf("\t\t\t 3.Rahul Gandhi                  3.Handn");
    Sleep(300);
    printf("\t\t\t 4.Arvind Kejriwal               4.Broomstick\n");
